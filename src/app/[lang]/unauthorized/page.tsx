  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative text-center max-w-md mx-auto">
        ...
        <h1 className="font-heading text-3xl font-bold text-foreground mb-3">Accès non autorisé</h1>
        <p className="text-[14px] text-muted-foreground mb-8 leading-relaxed">
          Vous n'avez pas les autorisations nécessaires pour voir cette page. Cet espace est réservé à des rôles d'utilisateurs spécifiques.
        </p>
        <Link href="/dashboard">
