...
export default async function PrivacyPage({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  const sections = lang === 'ar'
    ? [
        ...
        { icon: Eye, color: 'text-purple-500', bg: 'from-purple-500/10 to-purple-500/5 border-purple-500/20', title: 'مشاركة البيانات', body: 'قد نشارك بياناتك مع شركاء موثوقين (مثل Supabase لقواعد البيانات و Phyllo لإحصائيات المؤثرين) بالقدر اللازم فقط لتقديم الخدمة.' },
    ...
    ? [
        ...
        { icon: Eye, color: 'text-purple-500', bg: 'from-purple-500/10 to-purple-500/5 border-purple-500/20', title: 'Partage des données', body: 'Nous pouvons partager vos données avec des partenaires de confiance (comme Supabase pour les bases de données et Phyllo pour les statistiques d\'influenceurs) uniquement dans la mesure nécessaire à la prestation du service.' },
    ...
    : [
        ...
        { icon: Eye, color: 'text-purple-500', bg: 'from-purple-500/10 to-purple-500/5 border-purple-500/20', title: 'Data sharing', body: 'We may share your data with trusted partners (such as Supabase for databases and Phyllo for influencer statistics) only to the extent necessary to provide the service.' },
