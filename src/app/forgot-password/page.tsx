        ...
        <div className="rounded-3xl glass border border-border/30 shadow-soft p-8 text-center">
          {!sent ? (
            <>
              ...
              <p className="mt-2 text-[13px] text-muted-foreground">Enter your email and we&apos;ll send you a reset link</p>
            ...
            <>
              ...
              <p className="mt-2 text-[13px] text-muted-foreground">We&apos;ve sent a reset link to <strong className="text-foreground">{email}</strong></p>
              <p className="mt-4 text-[12px] text-muted-foreground/70">Didn&apos;t receive it? Check your spam folder or try again.</p>
