...
function StepIndicator({ current }: { current: number }) {
  const steps = [
    ...
    { label: 'Legal Details', icon: Scale },
      ...
      <div className="relative w-full max-w-lg mx-auto px-6 py-12">
        ...
        <div className="rounded-3xl glass border border-border/30 shadow-soft p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading text-2xl font-bold text-foreground">Set up your brand</h1>
            <p className="mt-2 text-[13px] text-muted-foreground">Tell us about your company to personalize your experience</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                {uploading ? (
                  <p className="text-[11px] text-vybe animate-pulse font-medium">Compressing & uploading...</p>
                ) : logoUrl ? (
                  <button
                    type="button"
                    onClick={handleRemoveLogo}
                  ...
                  <p className="text-[11px] text-muted-foreground">JPEG/PNG, auto-compressed to mobile-friendly size</p>
                )}
              </div>
            </div>

            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">Company name <span className="text-destructive">*</span></label>
              <Input placeholder="e.g. Pepsi Algeria" value={company} onChange={e => setCompany(e.target.value)} disabled={saving || uploading} />
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Industry <span className="text-destructive">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Company size <span className="text-destructive">*</span></label>
        ...
        <p className="mt-6 text-center text-[11px] text-muted-foreground/60">
          Step 1 of 3 — You can edit this later in Settings
        </p>
      </div>
    </div>
  );
